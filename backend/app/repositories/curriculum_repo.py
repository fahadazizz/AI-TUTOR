    ...
    async def upsert_concept(
        ...
        await self._execute(
            ...
            INSERT INTO concepts (
                ...
                visual_syntax, language_pack, textbook_sources, pedagogy_type,
            ...
            ON CONFLICT (concept_id) DO UPDATE SET
                ...
                visual_syntax = EXCLUDED.visual_syntax,
            ...
            """,
            concept_id, subject_id, chapter, chapter_name,
            name_en, name_ur, difficulty, board, grade, visual_need, visual_syntax,
